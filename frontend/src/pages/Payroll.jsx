  ...
  return (
    <Layout>
      ...
      <div className="payroll-page-header">
        <div>
          <span className="section-eyebrow">EMPLOYEE COMPENSATION</span>
          <h1 className="dashboard-heading">Salary & Payslip Overview</h1>
      ...
      <div className="payroll-highlights-grid">
        ...
        <div className="payroll-stat-card green highlight-card">
      ...
      <div className="saas-card payroll-main-card">
        <div className="card-header-row">
          ...
          <span className="payroll-period-badge">Period: {p.period || "August 2026"}</span>
        </div>
